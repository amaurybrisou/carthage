...
class LoadUserData implements FixtureInterface 
{
    public function load(ObjectManager $manager)
    {
       ...
       $image = new Image();$image->setFile('ac-90-2010-35x28-fenêtre.jpg');$image->setDescription('ac-90-2010-35x28-fenêtre.jpg');$image->setPage($page);$manager->persist($image);
        ...
        $image = new Image();$image->setFile('or20b-1983-hamel-triptique-details.jpg');$image->setDescription('or20b-1983-hamel-triptique-details.jpg');$image->setPage($page);$manager->persist($image);
        $image = new Image();$image->setFile('or20a-1983-hamel-triptique-91x80-details.jpg');$image->setDescription('or20a-1983-hamel-triptique-91x80-details.jpg');$image->setPage($page);$manager->persist($image);
